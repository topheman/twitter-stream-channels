...
var StreamChannels = function(apiClient, options) {
  ...
  addEvents(this.currentStream, this, options);
};
 ...
 * @returns {streamChannels}
 */
var addEvents = function(twitterStream, streamChannels, options){
  //transmit events
 ...
 * This class is private to the StreamChannels class, it's not exposed
 * @private
 * @class StreamChannels.postProcessing
 */
var postProcessing = {
  /**
   ...
   * @returns {Object}
   */ 
  extractChannelsAndKeywords : function(channels, tweet){
