 ...
 * 
 * Keep in mind this class is not designed to retrieved lots of tweets on long duration.
 * 
 ...
 * @param {String} [options.maxNumber=200] maximum number of tweets that will be retrieved (default 200)
...
var MockDataRetriever = function(credentials,options){
  ...
  if(typeof options.maxNumber === 'undefined' || options.maxNumber > 200){
